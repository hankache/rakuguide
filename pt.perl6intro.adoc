...
* Baixe o instalador (arquivo com extensão .dmg) mais recente em https://rakudostar.com/files/star

.Windows
. Baixe a última versão do instalador (arquivo com extensão .msi) em https://rakudostar.com/files/star +
