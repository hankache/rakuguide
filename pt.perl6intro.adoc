...
* Canal de IRC link:https://web.libera.chat/#raku[#perl6]. Muita discussão acontece no canal de IRC. Esse deve ser seu lugar de destino para qualquer questão: https://perl6.org/community/irc
