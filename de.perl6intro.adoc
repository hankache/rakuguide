...
| Postfix <d| Inkrementierung <m| my $var = 2; $var++;  <| Gebe den Inhalt der Variable aus `2` und inkrementiere dann um eins

.2+|\--| Prefix | Dekrementierung | my $var = 2; --$var;  | Dekrementiere die Variable um 1 und gebe das Resultat aus `1`

| Postfix <d| Dekrementierung <m| my $var = 2; $var--;  <| Gebe den Inhalt der Variable aus `2` und dekrementiere dann um eins
...
Die Diskussion findet auf dem link:https://web.libera.chat/#raku[#perl6] IRC Kanal statt. Dort läßt sich jede Frage stellen: +
