...
| 房间里有 4 个 people   | *对象* => 4 人
| 这 4 个人是 human    | *类* => Human
...
（译注，regular expression和regex都是“正则表达式”，一般来说后者是前者的缩写。本文中的regex包含是“Perl6专属”的用法，与其他语言中的正则表达式甚至Perl5的regex不完全一致，故不翻译，以示区分。）
