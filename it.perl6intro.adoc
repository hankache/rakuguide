...
:Author: Naoum Hankache; Marcello Dusini <marcello.dusini@gmail.com>
...
ogni linea: il codice deve contenere uno statement opportuno (per esempio `say`)
...
Altre persone della comunità usano anche http://www.vim.org/[Vim], https://www.gnu.org/software/emacs/[Emacs] or 
...
*Statements* sono tipicamente una linea logica di codice, necessitano di finire con punto e virgola:
`say "Ciao" if True;`

*Espressioni* sono speciali tipi di statement che ritornano un valore:
`1+2` restituirà `3`
