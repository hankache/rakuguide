...
-----
_l'indice 3 è fuori di uno dall'intervallo consentito (che deve essere 0..2)_
...
Fallirà con questo messaggio di errore: `Type check failed in assignment to $var; expected Int but got Str` [ossia _controllo sul tipo fallito per $var; mi aspettavo un Int ma ho ricevuto Str_]
