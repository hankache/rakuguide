...
`ls` lista tutti i file e le cartelle della directory corrente
...
Dopo aver fatto girare il codice qui sopra avremo un nuovo file _newdatafile.txt_ ;esso conterrà i nuovi punti.
