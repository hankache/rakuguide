...
== Classi e oggetti
Nel capitolo precedente abbiamo imparato come Perl 6 ficiliti la programmazione funzionale. +
In questo vedremo la programmazione orientata agli oggetti in Perl 6. Perl 6.

=== Introduzione

_programmazione orientata agli oggetti_ è uno dei paradigmi maggiormente usati oggi. +
Un *oggetto* è un insieme di variabili e funzioni riuniti tutti insieme in una unità. +
Le variabili vengono cambiati *attributi* mentre le funzioni vengono chiamate *metodi*. +
...
| Queste persone sono esseri umani | *classe* => umana
