...
:Author: Naoum Hankache; Marcello Dusini
...
NOTA: For the complete list of methods applicable to Strings, see https://docs.perl6.org/type/Str
...
NOTA: For the complete list of methods applicable to Integers, see https://docs.perl6.org/type/Int
...
NOTA: For the complete list of methods applicable to Rational Numbers, see https://docs.perl6.org/type/Rat
...
NOTA: For the complete Array reference, see https://docs.perl6.org/type/Array
...
NOTA: For the complete Hash reference, see https://docs.perl6.org/type/Hash
...
NOTA: For more info on variables, see https://docs.perl6.org/language/variables
