...
* scaricare l'ultimo installer (file con estensione .dmg) from https://rakudostar.com/files/star

.Windows
. Scaricare l'ultimo installer (file con estensione .msi) da https://rakudostar.com/files/star +
