...
== Subroutine
=== Definizioni
*Subroutine* (chiamate anche *sub* o *funzioni* o *procedure*) sono strumenti per riutilizzare delle specifiche funzionalità. +
...
say "1.2 al quadrato è uguale a " ~ squared(1.2);
----
====
