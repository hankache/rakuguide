...
* Téléchargez l'installateur (fichier avec l'extension .dmg) depuis https://rakudostar.com/latest/star/macos

.Windows
. Téléchargez l'installeur le plus récent (fichier avec une extension .MSI) de https://rakudostar.com/files/star +
