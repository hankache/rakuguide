...
То ще ви даде начален тласък в изучаването му. 
...
* Лесните неща трябва да са лесни, трудните да стават лесни, а невъзможните - трудни.
...
колкото ви е угодно празни пространства (за разлика от Питон).
...
| div | Вставка | Деление до цели числа (закръгля надолу) | 3 div 2 | 1

| % | Вставка | Деление до остатък | 7 % 4 | 3

.2+| %% .2+| Вставка .2+| Divisibility | 6 %% 4 | False

<| 6 %% 3 <| True

| gcd | Вставка | Greatest common denominator | 6 gcd 9 | 3

| lcm | Вставка | Least common multiple | 6 lcm 9 | 18

| == | Вставка | Numeric equal | 9 == 7  | False

| != | Вставка | Numeric not equal | 9 != 7  | True

| < | Вставка | Less than | 9 < 7  | False

| > | Вставка | Greater than | 9 > 7  | True

| \<= | Вставка | Less than or equal | 7 \<= 7  | True

| >= | Вставка | Greater than or equal | 9 >= 7  | True

| eq | Вставка | String equal | "John" eq "John"  | True

| ne | Вставка | String not equal | "John" ne "Jane"  | True

| = | Вставка | Assignment | my $var = 7  | Assigns the value of `7` to the variable `$var`

.2+| ~ .2+| Вставка .2+| String concatenation | 9 ~ 7 | 97

<m| "Hi " ~ "there"  <| Hi there

.2+| x .2+| Вставка .2+| String replication | 13 x 3  | 131313

<| "Hello " x 3  <| Hello Hello Hello

.5+| ~~ .5+| Вставка .5+| Smart match | 2 ~~ 2  | True
...
| .. | Вставка | Range Constructor |  0..5  | Creates a range from 0 to 5

| ..^ | Вставка | Range Constructor |  0..^5  | Creates a range from 0 to 4

| ^.. | Вставка | Range Constructor |  0^..5  | Creates a range from 1 to 5

| \^..^ | Вставка | Range Constructor |  0\^..^5  | Creates a range from 1 to 4

| ^ | Prefix | Range Constructor |  ^5  | Same as 0..^5 Creates a range from 0 to 4

| ... | Вставка | Lazy List Constructor |  0...9999  |  return the elements only if requested
...
=== Пускане на команди от системната обвивка
...
To build a lazy list we use the Вставка operator `...` +
