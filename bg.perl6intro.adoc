...
Пърл 6 е *свободна форма*: Свободни сте (през повечето време) да използвате паузи колкото ви е угодно.
...
Изразите са съставени от *Членове* и *Оператори*.
...
*Оператори*. Те са разпределени по типове:
...
| Следващ и ограждащ | След един член и ограждащ друг член | `Array[1]`
