...
* Son çıkan kurulum dosyasını(.dmg) indirmek için: https://rakudostar.com/files/star adresini ziyaret edin.

.Windows
* Son kurulum dosyasını(.msi) indirin, eğer sisteminiz 32-bit ise x86 dosyasını, 64-bit ise x86_64 dosyasını: https://rakudostar.com/files/star adresini ziyaret edin.
