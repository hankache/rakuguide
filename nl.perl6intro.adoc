...
Een variabele zal alleen toegankelijk zijn in een Raku script als er geen gebiedsbegrenzing gevonden wordt.
...
`echo` drukt de argumenten af (het equivalent van `print` in Raku) +
...
NOTE: Een overzicht van beschikbare Raku modules is te vinden op: https://modules.perl6.org/
...
NOTE: Zie https://docs.perl6.org/language/concurrency voor meer informatie over asynchroon programmeren in Raku
...
* link:https://www.reddit.com/r/perl6/[/r/perl6] ook op reddit kun je over Raku lezen
