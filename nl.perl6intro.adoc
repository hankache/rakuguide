...
. Installeer Zef: Typ het volgende commando in een terminalvenster `rakudobrew build zef`

. Ten slotte, installeer Task::Star.  Dit zal alle modules installeren die gebundeld zijn met de Rakudo Star Perl 6 distributie: `zef install Task::Star`
...
* Download de meest recente installer (bestand met .dmg extensie) van https://rakudo.org/downloads/star/

.Windows
. Download de meest recente installer (bestand met .msi extensie) van https://rakudo.org/downloads/star/ +
