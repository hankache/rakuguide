...
Lewat dokumen ini, anda akan menemukan beberapa contoh untuk topik yang banyak dibahas.
...
* *Zef*: program untuk mengelola instalasi modul dari Perl 6 module.
* *Rakudo Star*: Bundel program : Rakudo, Zef, koleksi beberapa modul Perl6 dan dokumentasi.

=== Cara Instalasi Perl 6
.Linux

Untuk menginstall "Rakudo Start", jalankan perintah berikut diterminal anda:
----
