...
CATATAN: Untuk tipe eksepsi yang lebih lengkap dan method terkait, kunjungi https://docs.perl6.org/type-exceptions.html
...
CATATAN: Untuk info lebih lanjut tentang regex, kunjungi https://docs.perl6.org/language/regexes
...
CATATAN: Direktori Modul Perl 6 dapat ditemukan di: https://modules.perl6.org/
...
CATATAN: Untuk info lebih lanjut tentang Concurrency dan Asynchronous, kunjungi https://docs.perl6.org/language/concurrency
...
CATATAN: Untuk info lebih lanjut pada Native Calling Interface, kunjungi https://docs.perl6.org/language/nativecall
