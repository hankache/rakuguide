...
También puedes escribir tu código en un archivo de texto, guardarlo y ejecutarlo. Es recomendable que los scripts de Raku tengan la extensión `.p6`. Ejecuta el archivo de esta forma: `perl6 nombre-archivo.p6` desde un terminal y pulsa [Enter]. La ejecución suele mostrar el resultado de sentencias como `say` para visualizar por la salida estándar contenidos de texto con un salto de línea al final .
...
NOTE: Puedes encontrar el directorio de módulos de Raku en: https://modules.perl6.org/
...
== La Comunidad
* En el canal de IRC link:irc://irc.freenode.net/#raku[#raku] se concentra la mayor parte del debate sobre Raku. En: https://perl6.org/community/irc puedes indicar cualquier duda.

* Resumen de las link:https://rakudoweekly.blog[noticias semanales sobre Raku].

* Mantente al día con los blogs que tratan de Raku en link:http://pl6anet.org[pl6anet].

* Suscríbete en el apartado de Raku de Reddit clicando en link:https://www.reddit.com/r/rakulang/[/r/rakulang].

* Sigue a la comunidad en Twitter: link:https://twitter.com/perl6org[@perl6org].

* Alertas de los desarrolladores de Raku, para mantenerse al día con los cambios importantes link:https://alerts.perl6.org[P6lert]
