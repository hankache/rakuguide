...
NOTA: Consulta http://doc.perl6.org/type/Str para ver una lista completa de métodos de texto.
...
NOTA: Consulta http://doc.perl6.org/type/Int para ver una lista completa de los métodos disponibles para enteros.
...
NOTA: Consulta http://doc.perl6.org/type/Rat para ver una lista completa de los métodos disponibles para números racionales.
...
NOTA: En http://doc.perl6.org/language/regexes tienes más información sobre regex.
...
NOTA: Puedes encontrar el directorio de módulos de Perl 6 en: http://modules.perl6.org/
