...
== La Comunidad
* En el canal de IRC link:irc://irc.freenode.net/#perl6[#perl6] se concentra la mayor parte del debate sobre Raku. En: https://perl6.org/community/irc puedes indicar cualquier duda.

* Resumen de los link:https://p6weekly.wordpress.com[cambios semanales en Raku].

* Mantente al día con los blogs que tratan de Raku en link:http://pl6anet.org[pl6anet].

* Suscríbete en el apartado de Raku de Reddit clicando en link:https://www.reddit.com/r/perl6/[/r/perl6].
