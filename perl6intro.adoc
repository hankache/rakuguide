...
* link:https://p6weekly.wordpress.com[p6weekly] a weekly overview of changes in and around Raku.

* link:http://pl6anet.org[pl6anet] blog aggregator. Stay tuned by reading blog posts that focus on Raku.

* link:https://www.reddit.com/r/perl6/[/r/perl6] subscribe to the Raku subreddit.
