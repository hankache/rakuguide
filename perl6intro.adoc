...
| lt | Infix | Sting less than | "a" lt "b" | True

| gt | Infix | Sting greater than | "a" gt "b" | False

| le | Infix | Sting less than or equal | "a" le "a" | True

| ge | Infix | Sting greater than or equal | "a" ge "b" | False
...
Luckily Perl 6 has methods/operators that implement the Unicode Collation Algorithm. +
