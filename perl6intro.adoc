...
Run the file by typing `perl6 filename.raku` into the terminal window
...
In the directory where you will be running the below script, create an empty folder `folder123` and an empty p6 file `script123.raku`
...
This should be your go to place for any enquiry: https://raku.org/community/irc
