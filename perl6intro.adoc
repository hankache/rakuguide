...
https://atom.io/packages/language-perl6fe[Perl6-fe] is an alternative Perl 6 syntax highlighter for Atom, derived from the original package but with many bugfixes and additions.
...
In addition we can define new methods/subroutines and call them using the hyper operator. In this case we have to append `&` before the name of the method. E.g. `&is-even`
