...
* Get the latest installer (file with .dmg extension) from https://rakudostar.com/latest/star/macos

.Windows
. For 64-bit architectures: Get the latest installer (file with .msi extension) from https://rakudostar.com/latest/star/win64 +
For 32-bit architectures: Get the latest installer (file with .msi extension) from https://rakudostar.com/latest/star/win32
...
`echo` prints text to the terminal (the equivalent of `say` in Perl 6) +
