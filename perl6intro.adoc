...
.Windows
. For 64-bit architectures: Get the latest installer (file with .msi extension) from https://rakudo.org/latest/star/win64 +
For 32-bit architectures: Get the latest installer (file with .msi extension) from https://rakudo.org/latest/star/win32
...
It is recommended that Raku scripts have a  `.p6` file name extension.
...
NOTE: The Raku modules directory can be found on: https://modules.perl6.org/
...
* link:irc://irc.freenode.net/#raku[#raku] IRC channel. Much discussion happens on IRC. This should be your go to place for any enquiry: https://perl6.org/community/irc

* link:https://rakudoweekly.blog[Raku do Weekly] a weekly overview of changes in and around Rakudo.
...
* link:https://alerts.perl6.org[P6lert] alerts from Raku Core Developers. Keep up to date with important changes.
